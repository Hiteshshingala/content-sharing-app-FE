...
export class PerformerAccountForm extends PureComponent<IProps> {
  ...
  render() {
    const { onFinish, user, updating, countries, options } = this.props;
          ...
          <Col md={24}>
            <Form.Item label="Avatar">
              ...
              >
                ...
                <div>Support all types of Image. Max upload size is 2MB!</div>
              </div>
            </Form.Item>
          </Col>
          <Col md={24}>
            <Form.Item label="Cover">
              ...
              >
                ...
                <div>Ratio dimension is 4:1 (eg 1600px:400px)</div>
