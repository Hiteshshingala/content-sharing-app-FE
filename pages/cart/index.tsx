...
import { Layout, Row, Col, Button, message, Input, Space } from 'antd';
...
import { IProduct, IUser, IUIConfig, ICoupon } from '../../src/interfaces';
import './cart.less';
...
class CartPage extends PureComponent<IProps> {
  ...
  render() {
    const { ui } = this.props;
    const { products, isApplyCoupon, coupon, couponCode } = this.state;
    ...
    return (
      <>
        <Head>
          <title>{ui && ui.siteName} | Cart</title>
        </Head>
        <Layout>
          <Content>
                ...
                >
                  ...
                  <Col span={12}>
                    <Input
                      ...
                      onChange={(value) =>
                        this.setState({ couponCode: value.currentTarget.value })
                      }
                  ...
                  <Col span={24}>
                    ...
                    <Space>
                      ...
                      {isApplyCoupon && coupon && (
                        <span>${calTotal(products, coupon.value)}</span>
                      )}
                    </Space>
                  </Col>
                  <Col span={24}>
