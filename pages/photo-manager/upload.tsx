...
import { Layout, message, Form, Button, Upload, Row } from 'antd';
...
class PhotoUploadPage extends PureComponent<IProps, IStates> {
  ...
  render() {
    ...
    return (
      <Layout>
        <Head>
          <title> {ui && ui.siteName} | Upload Photos </title>
        </Head>
        <Content>
          <div className="main-container">
            <BreadcrumbComponent
              breadcrumbs={[
                { title: 'Gallery Photo', href: '/gallery-manager/listing' },
                {
                  title: gallery ? gallery.name : '',
                  href: `/gallery-manager/update?id=${galleryId}`
                },
                { title: 'Upload New' }
              ]}
            />
